...
<Link href="/" style={{display: "inline-block", background: "white", color: "#8b5cf6", padding: "16px 32px", borderRadius: "12px", textDecoration: "none", fontWeight: 700, fontSize: "18px", marginTop: "20px"}}>Get Your Free Consultation →</Link>
</div>
