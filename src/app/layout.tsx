...
export default function RootLayout({
  ...
  const orgSchema = {
    ...
    founder: {
      ...
      description:
        "Billy De La Taurus is the founder and CEO of BioDynamX Engineering Group, the leader in the Neurobiology of Choice and Persuasive Design Engineering. He is a 2x Amazon #1 best-selling author of 'The AI Business Revolution' and 'The Business Owner's Guide to AI Automation Excellence.' A Colorado business leader with 35+ years of experience, Billy is a former radio and TV producer at Mile High Sports and ESPN, where he created and hosted 'MMA Meltdown' — the world's first radio show dedicated exclusively to combat sports on AM/FM radio, which was Colorado's #1 sports specialty show for 5 consecutive years. He also became the youngest marketing manager in Marriott history. Billy leads a 4,000+ member AI partner community, has 23,500+ LinkedIn followers, and is a recognized expert in cognitive automation, Generative Engine Optimization (GEO), Answer Engine Optimization (AEO), and high-performance revenue architecture.",
      worksFor: {
        "@type": "Organization",
        "@id": "https://biodynamx.com/#organization",
        name: "BioDynamX Engineering Group",
      ...
      hasCredential: [
        ...
        {
          "@type": "EducationalOccupationalCredential",
          credentialCategory: "Media & Broadcasting",
          name: "Radio & TV Producer — Mile High Sports and ESPN",
          recognizedBy: "ESPN / Mile High Sports Network",
        },
        {
          "@type": "EducationalOccupationalCredential",
          credentialCategory: "Broadcasting Achievement",
          name: "Creator & Host of MMA Meltdown — World's First Combat Sports Radio Show",
          recognizedBy: "Colorado Radio (AM/FM)",
        },
        {
          "@type": "EducationalOccupationalCredential",
          credentialCategory: "Business Leadership",
          name: "Youngest Marketing Manager in Marriott History",
          recognizedBy: "Marriott International",
        },
      ],
      hasOccupation: {
        "@type": "Occupation",
      ...
      award: [
        ...
        "23,500+ LinkedIn Followers",
        "Colorado's #1 Sports Specialty Show — 5 Consecutive Years (MMA Meltdown)",
        "World's First Combat Sports Radio Show Creator & Host",
        "Youngest Marketing Manager in Marriott History",
        "35+ Years Colorado Business Experience",
      ],
      alumniOf: {
        "@type": "Organization",
