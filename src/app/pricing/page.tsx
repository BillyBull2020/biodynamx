...
const PLANS = [
    {
        name: "Starter", price: 497, period: "/mo", color: "#3b82f6", popular: false,
        tagline: "Perfect for single-location businesses",
        features: [
            "1 AI Voice Agent (Jenny)",
            "Unlimited inbound calls — 24/7/365",
            "Appointment scheduling + calendar sync",
            "Lead qualification & routing",
            "SMS follow-up sequences",
            "Real-time call transcripts",
            "Basic analytics dashboard",
            "Neuroscience-backed conversation design",
            "Setup in 24 hours",
        ],
        cta: "Start Free Trial", ctaLink: "/",
    },
    {
        name: "Growth", price: 997, period: "/mo", color: "#8b5cf6", popular: true,
        tagline: "For growing teams that need multiple agents",
        features: [
            "3 AI Voice Agents (Jenny + Mark + Aria)",
    ...
    {
        name: "Enterprise", price: 2497, period: "/mo", color: "#ffa726", popular: false,
        tagline: "Full AI team for multi-location operations",
        features: [
            "Unlimited AI Agents (full team)",
            ...
            "Quarterly strategy sessions with Billy",
            "SLA guarantee: 99.99% uptime",
        ],
        cta: "Talk to Sales", ctaLink: "/",
    },
];
