...
const ONBOARDING_AGENTS = [
    ...
    { name: "Isabel", image: "/agents/isabel.png", color: "#8b5cf6", task: "Reputation management taken over. Social shield is now active." },
    ...
    { name: "Maya", image: "/agents/maya.png", color: "#a78bfa", task: "Drafting the task list you'll never have to do again." },
