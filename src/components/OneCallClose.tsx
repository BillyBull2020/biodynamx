...
const CLOSE_AGENTS = [
    ...
    { name: "Isabel", image: "/agents/isabel.png", color: "#8b5cf6", action: "Reputation protection on standby." },
    ...
    { name: "Maya", image: "/agents/maya.png", color: "#a78bfa", action: "Freedom protocol active. Workforce ready." },
