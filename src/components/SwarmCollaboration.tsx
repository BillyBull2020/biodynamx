...
const COLLAB_POOL = [
    ...
    { agent: "Iris", color: "#8b5cf6", message: "Social presence scan complete. Sending insights now." },
    ...
    { agent: "Megan", color: "#a78bfa", message: "Task delegation list updated — 3 new items automated." },
