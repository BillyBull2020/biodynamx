...
const AGENTS: Agent[] = [
    ...
    {
        id: "iris_visibility", name: "Isabel", role: "AI Visibility & Content (GEO/AEO)",
    ...
    {
        id: "megan_soother", name: "Maya", role: "AI Receptionist & Trust Builder",
    ...
    {
        id: "ava_growth", name: "Abby", role: "Content & Growth Strategy",
...
const TICKER = [
    ...
    "🎯  Isabel ranked a client #1 on Perplexity AI in 72 hours",
    "✅  0 calls missed across all active client accounts today",
    "🔒  Maya handled HIPAA-compliant intake for 14 patients",
    "🚀  Abby generated 3,200 inbound leads this week for a dental group",
