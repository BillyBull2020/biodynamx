...
const DOCK_AGENTS = [
    ...
    { name: "Isabel", image: "/agents/isabel.png", color: "#8b5cf6", task: "Preparing a custom visibility plan for you." },
    { name: "Maya", image: "/agents/maya.png", color: "#a78bfa", task: "Making sure you feel heard and informed." },
    ...
    { name: "Abby", image: "/agents/abby.png", color: "#f59e0b", task: "Crafting your brand story right now." },
