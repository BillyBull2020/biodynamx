...
const ADVANTAGES = [
    ...
    { icon: "🔍", title: "AI Visibility (GEO/AEO)", desc: "Isabel ensures you are suggested by Perplexity, Gemini, and ChatGPT.", color: "#8b5cf6" },
    { icon: "📱", title: "Social Media Admin", desc: "Isabel posts and manages all your social channels automatically.", color: "#ec4899" },
    { icon: "♻️", title: "Customer Reactivation", desc: "Jenny reaches out to old lists to generate reviews and repeat sales.", color: "#f59e0b" },
    { icon: "📲", title: "Textback / Callback", desc: "Maya instantly recovers missed calls via automated SMS & Voice.", color: "#a78bfa" },
